%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% INSTRUCTIONS: 
% 1. Use 'pdflatex' and compile TWICE.
% 2. Works in Evince, Okular, and Chrome/Firefox.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            \switchocg{#1}{%
                \begin{tikzpicture}
                    \begin{ocg}{shutter}{#1}{on}
                        \node[fill=black, rounded corners=1pt, 
                              fit=(hidden_text), inner sep=1.5pt] {};
                    \end{ocg}
                    % Transparent box that stays clickable when OCG is OFF
                    \begin{ocg}{trigger}{#1_trigger}{on}
                         \node[fill=white, opacity=0, 
                               fit=(hidden_text), inner sep=1.5pt] {};
                    \end{ocg}
                \end{tikzpicture}%
            }%
