...
\definecolor{Gold2}{RGB}{255,215,0}  % Gold color
\definecolor{Gold2!70}{RGB}{179,151,0}  % 70% Gold
...
\newcommand{\photoelectron}[3]{%
    \draw[rotate = #3](0,0) ellipse (#1 and #2)[color=blue];%
    \draw[decorate,decoration={coil,aspect=0,segment length=20pt},color=red!50!blue]%
        (#3:#1)-- +(-6,0)%
    ...
    \fill  (#1,0)[rotate=#3,color=white,opacity=0] circle (.1);%
...
\newcommand{\comptonelectron}[3]{%
    \draw[rotate = #3](0,0) ellipse (#1 and #2)[color=blue];%
    \draw[decorate,decoration={coil,aspect=0,segment length=10pt},color=red!50!blue]%
        (#3:#1)-- +(-6,0)%
        node[fill=white!70!Gold2,draw=red!80!white, above=0.2cm,pos=0.5]%
            {Incoming $\gamma$-photon};%
    ...
    \fill  (#1,0)[rotate=#3,color=white,opacity=0] circle (.1);%
    \draw  (#1,0)[rotate=#3,color=Gold2] circle (.1) ;%
    \draw[decorate,decoration={coil,aspect=0,segment length=15pt},color=red!50!blue,-stealth]%
        (#3:#1)-- ++(6,-3)%
...
\newcommand{\paircreation}[1]{%
    \draw[decorate,decoration={coil,aspect=0,segment length=5pt},color=red!50!blue]%
        (0,#1)-- +(-6,0)%
        node[fill=white!70!Gold2,draw=red!80!white, above=0.2cm,pos=0.5]%
            {Incoming $\gamma$-photon};%
